if (navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        let platform = new H.service.Platform({
            ...
            'apikey': '{8MQft-L7cgxgHklEyazkAJypAoko0VOJE50k18oo-V4}'
        });
        ...
        function addDraggableMarker(map, behavior) {
            ...
            // disable the default draggability of the underlaying map
            ...
            //Listen to the drag event and move the position pf the marker
            //asnecessary
